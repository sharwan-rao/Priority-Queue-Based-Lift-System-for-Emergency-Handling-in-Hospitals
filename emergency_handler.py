"""
EmergencyHandler: Detects emergency requests, triggers override mechanism,
and sorts emergency requests into Group A (current direction), Group B (opposite direction),
and Group C (future).

Enhanced with type hints and Enums.
"""
